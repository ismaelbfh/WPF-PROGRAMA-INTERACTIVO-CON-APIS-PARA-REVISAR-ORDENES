        ...
        private ImageSource GetIcon(MessageBoxImage pIcon)
        {
            ...
            switch (pIcon)
            {
                case MessageBoxImage.Error:
                    return new BitmapImage(new Uri("pack://application:,,,/WPF.GK.BARTENDER;component/Recursos/ErrorIcon.png", UriKind.Absolute));
                case MessageBoxImage.Warning:
                    return new BitmapImage(new Uri("pack://application:,,,/WPF.GK.BARTENDER;component/Recursos/WarningIcon.png", UriKind.Absolute));
                case MessageBoxImage.Information:
                    return new BitmapImage(new Uri("pack://application:,,,/WPF.GK.BARTENDER;component/Recursos/InformationIcon.png", UriKind.Absolute));
                case MessageBoxImage.Question:
                    return new BitmapImage(new Uri("pack://application:,,,/WPF.GK.BARTENDER;component/Recursos/QuestionIcon.png", UriKind.Absolute));
                default:
                    return null;
            }
        }
